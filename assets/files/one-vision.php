        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/one-vision.png" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">One Way Vission</h2>
                    <ul>
                        <li>Ideal for glass doors, shop fronts, car windows, and offices</li>
                        <li>See-through from inside, printed design on the outside</li>
                        <li>Perfect for privacy, branding, and promotional use</li>
                        <li>Weatherproof, UV-resistant, and long-lasting material</li>
                        <li>Printed using high-quality flex technology</li>
                        <li>Custom sizes and designs available</li>
                        <li>Easy to install and remove without damage</li>
                        <li><b>Hassan Graphics – Clear from inside, bold from outside</b></li>
                    </ul>
                </div>
            </div>
        </div>
