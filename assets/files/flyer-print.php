        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/flyer-print.png" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Flyer Printing</h2>
                    <p>Gain the highest exposure with the lowest cost through our affordable flyers. Perfect for promoting your brand, event, sale, campaign, or announcement to a large number of people.</p>
                </div>
            </div>
        </div>
    </section>
