        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/brocher-print.jpg" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Brochure Printing</h2>
                    <p>Create a one, two, or three-fold brochure to highlight your company story, services, or products. They are perfect for use in trade shows, presentations, or as takeaway menus.</p>
                </div>
            </div>
        </div>
    </section>
