        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/neon.jpg" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">NEOM</h2>
                    <ul>
                        <li>Custom LED neon signs for homes, shops, cafés, salons, events</li>
                        <li>Bright, colorful, and energy-efficient alternative to traditional</li>
                        <li>Made from flexible silicone LED tubing – safe, lightweight, and long-lasting</li>
                        <li>Available in multiple colors, fonts, and shapes</li>
                        <li>Great for indoor use and selected outdoor applications</li>
                        <li>Perfect for quotes, logos, business names, décor, and celebrations</li>
                        <li>Mounted on clear or colored acrylic backing – ready to hang or install</li>
                        <li>Remote control & dimmer options available</li>
                        <li>Low heat emission and safe for all environments</li>
                        <li><b>Hassan Graphics – Light up your brand with vibrant neon designs</b></li>
                    </ul>
                </div>
            </div>
        </div>
