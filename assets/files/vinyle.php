        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/vinyle.png" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Vinyle</h2>
                    <ul>
                        <li>High-quality vinyl for indoor & outdoor use</li>
                        <li>Perfect for signs, shop boards, glass, vehicles & walls</li>
                        <li>Waterproof, UV-resistant, and long-lasting material</li>
                        <li>Available in gloss, matte, transparent, and reflective finishes</li>
                        <li>Custom sizes and shapes to fit any surface</li>
                        <li>Sharp printing with bold colors using flex technology</li>
                        <li>Easy to apply – bubble-free & strong adhesive</li>
                        <li><b>Hassan Graphics – Durable vinyls, flawless results</b></li>
                    </ul>
                </div>
            </div>
        </div>
