        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/shop-model.png" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Shops Model</h2>
                    <ul>
                        <li>Custom-designed shop signage and display models</li>
                        <li>Durable materials suited for indoor and outdoor use</li>
                        <li>High-quality flex printing for vivid colors and sharp details</li>
                        <li>Options for lightbox signs, flex banners, acrylic displays, and more</li>
                        <li>Perfect for branding, promotions, and attractive storefronts</li>
                        <li>Easy installation and maintenance</li>
                        <li>Tailored solutions to match your shop’s theme and identity</li>
                        <li><b>Hassan Graphics – Build your brand’s first impression</b></li>
                    </ul>
                </div>
            </div>
        </div>
