        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/walpaper.jpg" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Wallpaper</h2>
                    <ul>
                        <li>High-quality wallpapers for homes, offices & shops</li>
                        <li>Custom designs to match your interior style</li>
                        <li>Vibrant colors with a smooth, premium finish</li>
                        <li>Printed using advanced flex printing technology</li>
                        <li>Easy to apply and durable for long-term use</li>
                        <li>Perfect for home décor, commercial branding & ambiance</li>
                        <li><b>Hassan Graphics – Trusted name in creative wall solutions</b></li>
                    </ul>
                </div>
            </div>
        </div>
