        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/x-stand.png" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Roll-up\X Stand\Streamers</h2>
                    <ul>
                        <li>Portable and easy-to-use banner displays</li>
                        <li>Retractable design for quick setup and compact storage</li>
                        <li>Ideal for trade shows, exhibitions, conferences, and promotions</li>
                        <li>High-quality printed vinyl banners with vibrant colors</li>
                        <li>Durable aluminum frame ensures stability and longevity</li>
                        <li>Multiple size options available (e.g., 24″x 60″, 33″x 80″)</li>
                        <li>Lightweight and easy to transport anywhere</li>
                    </ul>
                </div>
            </div>
        </div>
