...
<head>
    ...
    <title>Bussiness Card Printing</title>
        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/card-print.png" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Bussiness Card Printing</h2>
                    <p>Create a lasting impression with our top-selling business cards. We offer a variety of options from economy to premium business cards and a range of foil colors.</p>
                </div>
            </div>
        </div>
    </section>
