        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/reflecter-diamond.png" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Reflector Diamond</h2>
                    <ul>
                        <li>High-visibility reflective material – shines brightly in headlights</li>
                        <li>Perfect for road signs, safety boards, vehicles, and shop signage</li>
                        <li>Durable and weather-resistant for outdoor use</li>
                        <li>Available in multiple colors and reflective grades</li>
                        <li>Printed with precision using advanced flex printing technology</li>
                        <li>Long-lasting adhesive for strong bonding</li>
                        <li>Meets safety and visibility standards for commercial use</li>
                        <li><b>Hassan Graphics – Shine bright, stay visible</b></li>
                    </ul>
                </div>
            </div>
        </div>
