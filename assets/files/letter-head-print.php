...
<head>
    ...
    <title>Letter Head Printing</title>
        ...
        <div class="container">
            <div class="row content">
                <div class="col-12 col-md-6 ">
                    <div class="imag">
                        <img class="img-fluid" src="../images/letter-head-print.png" alt="img">
                    </div>
                </div>
                <div class="col-12 col-md-6 detail">
                    <h2 class="h2">Letter Head Printing</h2>
                    <p>Letterheads are a sure way to make your business look more presentable. Although letterheads are not considered promotional collateral, they serve to identify the sender and their message.</p>
                </div>
            </div>
        </div>
    </section>
